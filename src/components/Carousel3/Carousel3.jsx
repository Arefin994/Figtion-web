...
const Carousel3 = () => {
    return (
        <div>
            <div id="carouselExampleIndicators420" className="carousel slide" data-ride="carousel">
                <ol className="carousel-indicators">
                    <li data-target="#carouselExampleIndicators420" data-slide-to="0" className="active"></li>
                    <li data-target="#carouselExampleIndicators420" data-slide-to="1"></li>
                    <li data-target="#carouselExampleIndicators420" data-slide-to="2"></li>
                </ol>
                ...
                <a className="carousel-control-prev" href="#carouselExampleIndicators420" role="button" data-slide="prev">
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="sr-only">Previous</span>
                </a>
                <a className="carousel-control-next" href="#carouselExampleIndicators420" role="button" data-slide="next">
