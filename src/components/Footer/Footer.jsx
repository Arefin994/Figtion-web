                                ...
                                <div className="f-about">
                                    <div className="footer-logo">
                                        <a href="javascript:void(0)">
                                            <img className="w-25 h-50 rounded-5" src="/public/logo.PNG" alt="Logo" />
                                        </a>
                                    </div>
                                    <p className="text">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div
                                    className=" copyright text-center d-md-flex justify-content-between align-items-center">
                                    <p className="text-center">Copyright © 2023 Arefin Amin. All Rights Reserved</p>
                                    <ul className="social">
                                        <li>
                                            <a href="javascript:void(0)">
